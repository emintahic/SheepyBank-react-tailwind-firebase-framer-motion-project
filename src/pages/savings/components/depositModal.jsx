                        ...
                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                          ...
                          <div className="mt-2">
                            <p className="text-sm text-gray-500">
                              Type in the amount you want to save for this goal:
                            </p>
                          </div>
                          <div className="mt-2 flex flex-col gap-2 relative rounded-md shadow-sm">
                            <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-1 focus-within:ring-inset focus-within:ring-zelena-600 sm:max-w-md relative">
